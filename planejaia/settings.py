"""
Django settings for planejaia project.
...
SECRET_KEY = 'django-insecure-d!em9du28mf6e!%!mn+h)yomwk9x98k(q$nmfrunx!1ig($i_i'
...
INSTALLED_APPS = [
    ...
    'autenticacao',  # Certifique-se de que o app foi adicionado aqui
]
...
WSGI_APPLICATION = 'planejaia.wsgi.application'
